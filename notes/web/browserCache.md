...
原文：[https://www.cnblogs.com/lyzg/p/5125934.html](https://www.cnblogs.com/lyzg/p/5125934.html)
...
Expires是http1.0提出的一个表示资源过期时间的header，它描述的是一个绝对时间，由服务器返回。它的缓存原理是：
...
tomcat还提供了一个ExpiresFilter专门用来配置强缓存。
